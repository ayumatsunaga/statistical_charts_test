...
df = pd.read_excel(r'C:\Users\pccnf\Desktop\streamlit\ダッシュボードデータ.xlsx',sheet_name='電気情報通信機器',index_col='年月')
...
df = pd.read_excel(r'C:\Users\pccnf\Desktop\streamlit\ダッシュボードデータ.xlsx',sheet_name='在庫率',index_col='年月')
...
df = pd.read_excel(r'C:\Users\pccnf\Desktop\streamlit\ダッシュボードデータ.xlsx',sheet_name='生産動態項目別生産金額',index_col='年月')
...
df = pd.read_excel(r'C:\Users\pccnf\Desktop\streamlit\ダッシュボードデータ.xlsx',sheet_name='特サビ統計',index_col='年')
